...
export const CardIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    <path d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 4 8H4z" />
  </svg>
);
...
export const ReelsIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    <path fillRule="evenodd" d="M2 5a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V5zm4 0h8v10H6V5z" clipRule="evenodd" />
    <path d="M6 3a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zM6 17a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1z" />
  </svg>
);
...
export const StarIcon: React.FC<{isFilled: boolean}> = ({ isFilled }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill={isFilled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2">
...
export const ExitFullscreenIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 4H4m0 0v4M4 4l5 5m7-5h4m0 0v4m-4-4l-5 5M8 20H4m0 0v-4m0 4l5-5m7 5h4m0 0v-4m-4 4l-5-5" />
    </svg>
);
