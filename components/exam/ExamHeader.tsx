...
const ExamHeader: React.FC<ExamHeaderProps> = ({ title, onBack }) => (
  <header className="w-full bg-white dark:bg-gray-800 shadow-md p-4 flex items-center justify-between z-10 flex-shrink-0">
    <button
      onClick={onBack}
      className="px-4 py-2 rounded-md bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 font-semibold transition-colors flex items-center"
    >
